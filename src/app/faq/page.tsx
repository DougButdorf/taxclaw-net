    ...
    items: [
      {
        ...
        a: "We're building a Pro plan and would love your input on what it should include. If you have feature requests or ideas, use the contact form — it directly shapes what we prioritize.",
      },
      {
